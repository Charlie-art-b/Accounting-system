<x-filament::page>
    ...
    @if ($generated)
        ...
        <x-filament::section heading="Balance General">
            ...
            <div class="mt-4">
                @if ($balance['ecuacion_balanceada'] ?? false)
                    <div class="text-green-600 font-semibold">✔ La ecuación contable está balanceada</div>
                @else
                    <div class="text-red-600 font-semibold">✖ La ecuación NO está balanceada</div>
                @endif
            </div>
